...
export function CliProxyAccountsEmpty() {
  return (
...
export function CliProxyAccountsTable({
  ...
  readonly state: CliProxyAccountsState;
      ...
      <Table>
        ...
        <TableBody>
          {accounts.map((account) => {
            const pending = isCliProxyAccountPending(state, account.id);
              ...
              >
                ...
                <TableCell>
                  <Switch
                    ...
                    aria-label={`${account.disabled ? "Enable" : "Disable"} ${describeCliProxyAccount(account)}`}
                  />
                </TableCell>
                <TableCell>
                  <WeightInput
                ...
                <TableCell>
                  <Button
                    size="icon-micro"
                    variant="ghost-muted"
                    aria-label={`Remove ${describeCliProxyAccount(account)}`}
                    disabled={pending}
...
function WeightInput({
  ...
  return (
    <Input
      ...
      placeholder="1"
      disabled={disabled}
      aria-label={`Weight for ${describeCliProxyAccount(account)}`}
